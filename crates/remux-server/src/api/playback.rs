...
async fn videos_stream_inner(
    ...
    let params = crate::transcode::engine::ProgressiveTranscodeParams {
        ...
        video_bitrate: source_video_stream
            ...
            .map(|b| {
                let source = b as u32;
                q.video_bit_rate.map_or(source, |v| source.min(v as u32))
            }),
        audio_bitrate: q
            .audio_bit_rate
            .map(|v| v as u32),
        ...
        .get_transcode(&play_session_id)
    {
        ...
        let params = crate::transcode::engine::TranscodeParams {
            ...
            video_bitrate: source_video_stream
                ...
                .map(|b| {
                    let source = b as u32;
                    let target = q.video_bit_rate.map_or(source, |v| source.min(v as u32));
                    q.max_streaming_bitrate.map_or(target, |c| target.min(c as u32))
                }),
            audio_bitrate: q
                .audio_bit_rate
                .map(|v| v as u32),
